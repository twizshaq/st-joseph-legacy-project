...
export default function ShareIcon({
  ...
  if (typeof color !== "string") {
    console.error("ShareIcon: 'color' prop must be a string.");
  }
  if (typeof size !== "number") {
    console.error("ShareIcon: 'size' prop must be a number.");
  }
  if (typeof className !== "string") {
    console.error("ShareIcon: 'className' prop must be a string.");
  }
