...
import NoReviewsIcon from "@/public/icons/noreviews-icon";
...
const SoupBowl = () => {
  ...
  image: "https://i.pinimg.com/736x/ac/c5/16/acc5165e07eba2b8db85c8a7bcb2eda6.jpg", // Replace with real high-res image
  photo360: "https://shaq-portfolio-webapp.s3.us-east-1.amazonaws.com/Andromeda_20250920_110344_00_008.jpg" // Replace with real 360 image
};
    ...
    <div className='flex flex-col items-center self-center min-h-[100dvh] text-black bg-red-500/0 overflow-hidden'>
      <div className="relative flex flex-col justify-center items-center w-[100vw] max-w-[2000px] h-[100svh] text-white gap-[20px] overflow-hidden group">
        ...
        {activeMedia === 'video' && (
          ...
          >
            <source src={headerMedia.video} type="video/mp4" />
          </video>
        )}
        ...
        {activeMedia === '360' && (
          <div className="absolute top-0 left-0 w-full h-full animate-in fade-in duration-500 bg-black cursor-move">
             ...
             <ReactPhotoSphereViewer 
                src={headerMedia.photo360} 
                height={'100%'} 
                width={"100%"}
                container={""}
                // Optionals to make it look cleaner in a header
                defaultZoomLvl={0} 
                navbar={false} // Hide the bottom control bar for a cleaner "hero" look
             />

            {/* 2. Overlay Text (pointer-events-none ensures you can drag 'through' the text) */}
            {/* <div className="absolute inset-0 flex items-center justify-center pointer-events-none z-10">
               <span className="text-xl md:text-4xl font-bold bg-black/30 px-6 py-2 rounded-full border border-white/20 backdrop-blur-md opacity-70">
                 Drag to Explore 360°
               </span>
            </div> */}
          </div>
      ...
      <div className='grid grid-cols-1 xl:grid-cols-12 gap-12 md:w-[90vw] max-w-[1400px] px-[5vw] xl:px-0 mt-[60px] md:mt-[80px] mb-[80px]'>
        ...
        {/* UPDATED: Uses 'md:flex-row' to go side-by-side on tablets, but 'xl:flex-col' to stack on desktop */}
        <div className='col-span-1 xl:col-span-5 w-full flex flex-col md:flex-row md:flex-wrap xl:flex-col items-start xl:items-end justify-center gap-6 xl:gap-10 h-fit'>
          ...
          {/* Removed mt-4 to keep spacing consistent in grid */}
          ...
          {/* w-full max-w-[450px] allows it to be flexible but consistent with the card above */}
        ...
        <div className='relative flex flex-row justify-center items-end bg-green-500/0 min-h-[360px] sm:min-h-[420px] overflow-visible'>
          ...
          <div className='relative w-full flex justify-center items-end z-10 origin-bottom max-sm:scale-[0.76]'>
            ...
            <div 
              ...
              style={{ backgroundImage: `url(${galleryItems[4]?.src})` }}
            ></div>
            ...
            <div 
              ...
              style={{ backgroundImage: `url(${galleryItems[5]?.src})` }}
            ></div>
            ...
            <div 
              ...
              style={{ backgroundImage: `url(${galleryItems[6]?.src})` }}
            ></div>
      ...
      <div className='relative flex flex-col items-center w-[1400px] max-w-[90vw] mb-[120px]'>
        ...
        <div className='flex overflow-x-auto pb-12 pt-4 gap-6 w-full px-4 max-sm:px-5 scroll-smooth mandatory hide-scrollbar'>
          ...
          // Use data from the LIVE profile table
          // Fallback to the snapshot if the profile link fails (just in case)
        ...
        <div className='flex flex-wrap justify-center gap-3 mt-4'>
          ...
          <button 
            onClick={() => setCurrentPage(currentPage + 1)}
            disabled={currentPage === pageCount || reviews.length === 0}
            className='flex items-center cursor-pointer justify-center w-11 h-11 active:scale-[.98] bg-white/80 border border-slate-200/80 text-slate-500 rounded-2xl shadow-[0px_0px_10px_rgba(0,0,0,0.1)] hover:bg-white hover:scale-[1.05] hover:text-blue-600 transition-all disabled:cursor-default disabled:hover:scale-100 disabled:bg-slate-100 disabled:text-slate-400'
          >
