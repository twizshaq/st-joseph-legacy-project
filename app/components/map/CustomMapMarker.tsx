...
const CustomMapMarker: React.FC<CustomMapMarkerProps> = ({
    ...
    if (isTextMode) {
        return (
            ...
            >
                <div className="w-auto bg-white/40 backdrop-blur-[3px] p-[3px] rounded-full shadow-[0px_0px_10px_rgba(0,0,0,0.1)]">
    ...
    return (
        ...
        >
            <div className="bg-white/40 backdrop-blur-[3px] rounded-full p-[3px] max-sm:p-[3px] shadow-[0px_0px_10px_rgba(0,0,0,0.1)]">
                <div
                    style={circleStyle}
                    className="w-[35px] h-[35px] rounded-full bg-cover bg-center z-20"  // Removed /50; add bg-opacity-50 if needed
                />
            </div>
            <div className="w-[20px] h-[20px] bg-white/90 shadow-[0px_0px_10px_rgba(0,0,0,0.2)] transform rotate-45 -mt-[15.5px] rounded-[4px] z-[-1]" />
        </div>
