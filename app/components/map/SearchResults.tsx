      ...
      >
        <div className={`relative transition-all duration-300 ease-[cubic-bezier(0.25,0.1,0.25,1)] transform-gpu ${mobileSearchOpen ? 'mt-[13px] w-[93%] mx-auto' : 'w-full self-center'}`}>
          ...
          <button
            ...
            type="button"
            onClick={toggleSort}
            className='flex gap-[8px] py-[10px] cursor-pointer items-center justify-center absolute font-bold right-[14px] top-[3px] text-[#E0E0E0] transition-colors'
          >
                    ...
                    <div className="flex flex-col gap-2">
                      {[
                        ...
                        <button
                          ...
                          className={`text-left cursor-pointer px-4 py-2 rounded-2xl text-sm font-bold transition-all ${
