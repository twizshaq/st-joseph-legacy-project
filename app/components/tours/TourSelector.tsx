...
const TourSelector: React.FC<TourSelectorProps> = ({ 
  ...
  return (
    <div className="relative w-[300px] max-w-[90vw] mx-auto z-[30]" ref={menuRef}>
      ...
      {/* --- Dropdown Menu --- */}
      <div className={`absolute top-[calc(100%+12px)] bg-white/10  shadow-[0px_0px_15px_rgba(0,0,0,0.1)] left-0 w-full backdrop-blur-[10px] rounded-[53px] p-[3px] transition-all duration-300 origin-top
        ...
        <div 
          className={`
              ...
              rounded-[50px]
              overflow-hidden
              shadow-[0px_0px_2px_rgba(0,0,0,.1)]
          `}
        >
