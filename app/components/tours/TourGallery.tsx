...
export function TourGallery({ images }: TourGalleryProps) {
    ...
    return (
        <div className="mb-8 h-[400px] md:h-[450px] w-full relative overflow-hidden border-white border-[3px] shadow-[0px_-10px_20px_rgba(0,0,0,0.2)] rounded-[43px]">
            ...
            {/* --- Previous Button --- */}
            <div className={`hidden md:flex absolute left-[1vw] top-1/2 -translate-y-1/2 z-[29] items-center justify-center p-[2.5px] rounded-full bg-white/10 backdrop-blur-[5px] shadow-[0px_0px_15px_rgba(0,0,0,0.3)] transition-all duration-100 active:scale-[0.93] cursor-pointer ${canScrollLeft ? 'opacity-100' : 'opacity-0 pointer-events-none'}`}>
                <button
                    type="button"
                    onClick={scrollLeft}
            ...
            {/* --- Next Button --- */}
            <div className={`hidden md:flex absolute right-[1vw] top-1/2 -translate-y-1/2 z-[29] items-center justify-center p-[2.5px] rounded-full bg-white/10 backdrop-blur-[5px] shadow-[0px_0px_15px_rgba(0,0,0,0.3)] transition-all duration-100 active:scale-[0.93] cursor-pointer ${canScrollRight ? 'opacity-100' : 'opacity-0 pointer-events-none'}`}>
                <button
                    type="button"
                    onClick={scrollRight}
