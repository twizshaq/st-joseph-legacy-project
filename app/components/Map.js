...
const Map = forwardRef((props, ref) => {
    ...
    return (
        <div className='h-full w-full relative'>
            ...
            <div className="absolute top-[130px] max-sm:left-[17px] left-[23px] flex flex-col items-center">
                <button onClick={handleResetNorth} className="rounded-full bg-black/40 backdrop-blur-[5px] active:bg-black/30 shadow-lg w-[50px] h-[50px] flex items-center justify-center" aria-label="Reset bearing to north">
