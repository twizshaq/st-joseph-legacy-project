      ...
      <div className='rounded-[35px] active:scale-[.99] border border-amber-500/30 bg-white/95 backdrop-blur-sm overflow-hidden transition-all duration-300 shadow-[0_0px_20px_rgb(0,0,0,.1)]'>
        ...
        <div className={`${isOpen ? 'max-h-[500px] opacity-100' : 'max-h-0 opacity-0'} overflow-hidden bg-white relative transition-all duration-300`}>
          <div className='px-6 pb-6 pt-4 relative z-10'>
            <p className='text-[0.95rem] leading-[1.6] text-slate-600 mb-4'>East coast seas are unpredictable. Avoid swimming during high swells. Monitor weather advisories.</p>
            <ul className='space-y-3 mb-5'>
              <li className="flex gap-3 items-start"><span className="mt-1.5 min-w-[6px] h-[6px] rounded-full bg-amber-500 shadow-[0_0_8px_rgba(245,158,11,0.6)]"></span><span className="text-[0.9rem] text-slate-500 font-medium">Use designated zones for photography.</span></li>
              <li className="flex gap-3 items-start"><span className="mt-1.5 min-w-[6px] h-[6px] rounded-full bg-amber-500 shadow-[0_0_8px_rgba(245,158,11,0.6)]"></span><span className="text-[0.9rem] text-slate-500 font-medium">Park away from soft shoulders.</span></li>
            </ul>
            <div className='relative flex items-start gap-3 mt-4 bg-amber-50 border border-amber-100 p-3 rounded-[25px] overflow-hidden'>
              ...
              <div className="flex flex-col relative z-10">
                ...
                <span className="text-[0.85rem] text-amber-800/70 leading-tight mt-1">• 211 Police <br /> • 511 Ambulance <br /> • 311 Fire</span>
              </div>
            </div>
          </div>
        </div>
