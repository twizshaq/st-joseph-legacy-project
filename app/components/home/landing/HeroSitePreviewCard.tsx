...
export default function HeroSitePreviewCard({
  ...
  return (
    <div
      ...
      className={`relative mx-auto h-[330px] w-[260px] select-none transition-[transform,opacity] duration-700 [transition-timing-function:cubic-bezier(0.22,1,0.36,1)] will-change-[transform,opacity] ${
    ...
    >
      <div className="relative h-[330px] w-[260px] scale-100 duration-200">
        <div
          className="absolute inset-0 flex scale-x-[1.03] scale-y-[1.025] flex-col justify-end overflow-hidden rounded-[57px] bg-cover bg-center brightness-[.8] shadow-[0px_0px_15px_rgba(0,0,0,0.3)]"
          style={{ backgroundImage: `url(${imageUrl})` }}
        />

        <div
          className="relative z-10 flex h-full w-full flex-col justify-end overflow-hidden rounded-[54px] bg-cover bg-center brightness-[1.5]"
          style={{ backgroundImage: `url(${imageUrl})` }}
        >
          <div className="pointer-events-none absolute bottom-0 right-0 rotate-[180deg]">
            <div className="h-[200px] w-[270px] bg-black/40 opacity-100 [mask-image:linear-gradient(to_bottom,black_50%,transparent)]" />
          </div>
