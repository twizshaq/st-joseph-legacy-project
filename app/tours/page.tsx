    ...
    <div className="flex flex-col items-center overflow-x-hidden text-black" onClick={(e) => {
              ...
              <div className="w-full lg:w-1/2 order-1 lg:order-2">
                <div className="relative grid grid-cols-12 gap-4 h-[280px] sm:h-[350px] md:h-[550px]">
                  ...
                  <div className="col-span-5 flex flex-col gap-4">
                    <div className="h-[60%] relative rounded-[40px] md:rounded-[5rem] overflow-hidden ring-1 ring-black/5 [0px_0px_10px_rgba(0,0,0,0.3)]">
                      <div className="absolute inset-0 bg-blue-500" />
                      {/* <Image 
                    ...
                    <div className="h-[40%] relative rounded-[35px] md:rounded-[4.2rem] overflow-hidden bg-blue-500 flex items-center justify-center group cursor-pointer shadow-[0px_0px_10px_rgba(0,0,0,0.3)]">
      ...
      <div className='flex justify-center gap-[15px] right-[10px] bottom-[10px] cursor-pointer whitespace-nowrap rounded-full p-[3px] relative'>
        ...
        {isPopupOpen && (
          <div 
            ref={popupRef} 
            className="absolute top-full mt-2 bg-white/80 rounded-[28px] backdrop-blur-[10px] p-[2.5px] shadow-[0px_0px_20px_rgba(0,0,0,.2)] w-fit flex flex-wrap z-[40] overflow-hidden"
          >
            <div className="flex flex-col gap-2 w-full bg-black/5 rounded-[25px] p-[5px]">
              ...
              {tours.map((t) => (
                ...
                >
                  ...
                  <p className="font-[600] text-[.9rem] text-left line-clamp-2">
                    {t.name}
                  </p>
                </button>
              ))}
