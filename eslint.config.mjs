...
{ ignores: ['.next/**', 'node_modules/**', 'dist/**', 'out/**', 'coverage/**'] }, // 2) Next.js + TypeScript presets (via compat)
...compat.extends('next/core-web-vitals', 'next/typescript'), // 3) Project-wide rules (add tweaks here if you want)
{
  files: ['**/*.{ts,tsx,js,jsx}'],
